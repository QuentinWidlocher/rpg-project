...
export function Initiative(props: {
  ...
  findInAllCharacter: <T extends Character = Opponent | PlayerCharacter>(predicate: (character: { value: Character }) => boolean) => { value: T; set: SetStoreFunction<T> }
        ...
        <>
          {(i == 0
            ...
            <li
              ...
              style={{
                "--value": (character.hp.current / getMaxHp(props.findInAllCharacter(c => c.value.id == character.id).value)) * 100,
                "--thickness": "4px",
              }}
              role="progressbar"
