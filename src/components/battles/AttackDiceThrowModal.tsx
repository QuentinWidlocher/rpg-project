...
export function AttackDiceThrowModal(props: {
  onClose: () => void;
            ...
            <div class="card-body bg-base-200 rounded-xl text-center">
              <div class="flex mx-auto gap-1 items-center ">
                <span class="countdown text-4xl">
                  <span class={twJoin(rollingResult().details.hitRoll == 20 ? 'text-success' : 'opacity-50')} style={{ "--value": rollingResult().details?.hitRoll }} />
                </span>
