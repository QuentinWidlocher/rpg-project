...
export function AttackResultDetailsTooltipContent(props: {
  attackResultDetails: AttackResult['details']
}) {
  return (<div class="tooltip-content">
    ...
    {"damageRoll" in props.attackResultDetails
      ? `${props.attackResultDetails.damageRoll}${props.attackResultDetails.damageModifier ? ` + ${props.attackResultDetails.damageModifier} dmg` : ""}`
      : ""}
  </div>
  )
}
