  ...
  return <DialogComponent dialog={makeDialog([
    {
      ...
      choices: [
        ...
        { text: () => "How much for a room ?", effect: (props) => props.setNext('room'), condition: () => getFlag('npc.inn.restedOnce') == false },
        { text: () => "Nothing, I was just visiting", effect: (props) => props.setNext('goodbye') }
      ],
    ...
    },
    {
      id: 'room',
      text: () => (<>
        <blockquote>Only five silver coins for the night, interested ?</blockquote>
      </>),
      choices: [
        restChoice,
        { text: () => "No sorry, I'll go now", effect: (props) => props.setNext('goodbye') }
      ]
    },
    {
      id: 'goodbye',
