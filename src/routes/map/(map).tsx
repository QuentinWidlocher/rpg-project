...
export default function Map() {
  return (
    <>
      <Layout title="Upper City" illustration={<img class="w-full h-full object-cover" src="https://artfiles.alphacoders.com/132/132525.jpg" />}>
        <div class="grid grid-cols-2 gap-5 overflow-y-auto scrollbar scrollbar-track-base-200 scrollbar-thumb-base-300 -m-8 p-8">
          {zones.map(zone => (
            <A href={zone.disabled ? '' : zone.href} aria-disabled={zone.disabled} class="btn btn-ghost aria-disabled:!text-base-400 aria-disabled:!bg-base-300 aria-disabled:btn-disabled hover:bg-primary hover:text-primary-content bg-base-300 w-full h-32 flex flex-col">
