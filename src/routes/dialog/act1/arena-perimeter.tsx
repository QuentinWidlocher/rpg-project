...
import { Act1FightState } from "./arena-perimeter-fight";
...
export default function ArenaDialog() {
	...
	const goToFight = (state?: Act1FightState) => navigate(FIGHT_ROUTE, { state });
	const goToArena = () => navigate(ARENA_ROUTE, { state: { dontRedirect: true } });
			...
			dialog={[
				// --- Step 0: Arena Description (if plot not active) ---
				{
					...
					text: () => (
						<>
							<p>
								{CITY_NAME} is famous for its arena! It's in the middle of this semi-circle of stands, shaded by colorful
				...
				{
					exitFunction: () => navigate(TOWN_ROUTE),
					id: "criminalFlee",
