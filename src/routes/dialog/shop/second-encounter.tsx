											...
											>
												...
												<div class="collapse-content space-y-5">
													...
													<button
														...
														onClick={() => {
															setPlayer("inventory", player.inventory.length, createArmor(armorKey));
											...
											>
												...
												<div class="collapse-content space-y-5">
													...
													<button
														...
														onClick={() => {
															setPlayer("inventory", player.inventory.length, createWeapon(weaponKey));
