			...
			dialog={makeDialog([
				{
					...
					text: () => (
						<>
							<p>
								Facing you is a female dwarf with dense, frizzy hairs(including her
								beard).
							</p>
							<p>
								She doesn't seem to have noticed you yet, as she's busy organizing
								shelves and updating her inventory.{" "}
							</p>
						</>
					),
					choices: [
				...
				},
				{
					text: () => (
						<>
							...
							<blockquote>
								Sorry here !<br /> You surprised me, I was so absorbed in my work I
					...
					choices: [
						{
							...
							effect: props => props.setNext("buy-explanation"),
						},
						{
							text: () => "I need to sell stuff",
							effect: props => props.setNext("sell-explanation"),
						},
					],
				...
				},
				{
					...
					text: props => (
						<>
							<blockquote>
								{props.isFrom("questions-about-services")
									? "Of course !"
									: "But you can also buy things."}
								<br />
								You can find everything you need here !
							</blockquote>

							<p>
								She marks {props.isFrom("sell-explanation") ? "another" : "a"} short
								pause.
							</p>
					...
					text: props => (
						<>
							<blockquote>
								{props.isFrom("questions-about-services")
									? "Of course !"
									: "But you can also sell me things."}
								<br />I buy pretty much anything from adventurers.
							</blockquote>

							<p>
								She marks {props.isFrom("buy-explanation") ? "another" : "a"} short
								pause.
							</p>
				...
				},
				{
					...
					text: () => (
						<>
							...
							{state.waited ? (
								<blockquote>And sorry again for earlier.</blockquote>
							) : null}
						</>
					),
