  ...
  return <DialogComponent dialog={makeDialog([
    {
      ...
      text: () => <>
        ...
        <blockquote>
          YOU ! HAVE YOU COME TO SHOW THE WORLD WHAT YOU'RE CAPABLE OF ??
        </blockquote>
      </>,
      choices: [
        ...
        { text: () => 'Ignore him and walk away', effect: () => navigate('/map') },
      ]
    },
    {
      text: () => <>
        {state.enthusiast ? <blockquote>THAT'S WHAT I WANT TO HEAR ! <br /></blockquote> : null}
        <blockquote>COME ! SIGN THIS FORM AND YOU'LL GET GLORY AND RICHES !</blockquote> <br />

        His screams are hurting your ears.
      </>,
      choices: [
        { text: () => 'Sign up to fight in the arena', effect: (props) => props.setNext('last') },
    ...
    },
    {
      ...
      choices: [
        ...
        {
          text: () => '[Intelligence] Uncheck the "deathmatch" mention in the contract before signing up',
          condition: () => skillCheck(player, 'intelligence', 15),
        },
        { text: () => 'Just sign up' },
      ]
    },
    {
      id: "last",
      text: () => <blockquote>THANK YOU. I CAN'T WAIT TO SEE YOU FIGHT INSIDE <br /> ... <br /> THE ARENAAAAA</blockquote>,
      choices: [
        { text: () => 'YEAH', condition: () => state.enthusiast },
