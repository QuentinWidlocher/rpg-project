  ...
  return <DialogComponent onDialogStop={props.then} dialog={makeDialog([
    {
      title: 'Victorious',
      text: <>
        <span>The {opponentName} fell to the ground, you bring your {equippedWeapon()} to their neck before they can get back to their feet..</span> <br /> <br />
    ...
    },
    {
      text: <>
        ...
        <span>They seem a bit relieved and continue to talk</span> <br /><br />
        <blockquote>
          I'm so sorry, I will give the old man his things back, I'll help them get back on the road I <strong>swear</strong> ! <br />
        </blockquote>
      </>,
      choices: [
        { text: 'Help them get the old man cart back on four wheels', effect: goTo('getting-the-cart-up') },
        skillCheckChoice(player, 'intimidation', 1, { text: 'Ask for their money too', success: goTo('asked-their-money-success'), failure: goTo('asked-their-money-fail') }),
        skillCheckChoice(player, ['intimidation', 'persuasion'], 10, { text: 'Ask them to abandon their way', effect: goTo('asked-to-stop') }),
      ]
    },
    {
      ...
      text: <>
        ...
        <SkillCheck character={player} skill="insight" dd={10}>They're right, they don't have anything.</SkillCheck>
      </>,
    ...
    },
    {
      id: 'asked-to-stop',
      text: <>
        <blockquote>Erm, yeah ! Okay okay, you're right, I need to turn my life over and rethink my choices.</blockquote> <br /><br />
        <SkillCheck character={player} skill="insight" dd={10}>Obviously, they're just saying this so you don't cut their throat.</SkillCheck>
      </>
    },
    {
    ...
    },
    {
      ...
      text: <>
        <span>Before they could say anything more, the blade of your {equippedWeapon()} slit their throat open.</span> <br />
        <span>As the {opponentName} convulses on the floor, the horrified old man stand there, waiting for your next move.</span>
      </>,
  ...
  return <DialogComponent onDialogStop={props.then} dialog={makeDialog([
    {
      ...
      text: <>
        <span>You lie on the ground, inconcious, as the {opponentName} starts to strip you from you belongings. </span> <br /><br />
        <em>The {opponentName} took your {removedItem.name}</em>
      </>,
      enterFunction: () => { setPlayer('inventory', (inventory) => inventory.filter(i => i.id != removedItem.id)) },
    },
    {
      text: <>
        <span>You emerge some time later. The sun is already low on the horizon and the {opponentName} is nowhere to be found.</span> <br />
        <span>The old man lies in a puddle of blood, the cart is empty.</span><br /> <br />
